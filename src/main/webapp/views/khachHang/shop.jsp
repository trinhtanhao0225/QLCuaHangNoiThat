...
.header {
    display: flex;
    justify-content: space-between; /* Chia đều khoảng cách giữa các phần */
...
#search-box input {
    ...
    padding: 5px 10px;
    font-size: 14px;
    max-width: 80%; /* Thanh tìm kiếm sẽ chiếm 80% chiều rộng của khung cha */
...
.login-button-container {
    margin-left: 20px; /* Khoảng cách giữa nút Đăng nhập và các phần khác */
}
...
<body>
    ...
    <footer class="footer">
        ...
        <div class="footer-section">
            ...
            <a href="#" class="map-link">Số 1 Võ Văn Ngân, Linh Chiểu, Thủ Đức, Thành Phố Hồ Chí Minh »</a>
        </div>
        <div class="footer-section">
